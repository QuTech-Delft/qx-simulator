...
protected:
    ...
    TreeOne<CqasmV3xVariableRef> q_variable_ref_sp =
        TreeOne<CqasmV3xVariableRef>{ std::make_shared<CqasmV3xVariableRef>(q_variable_ref) };
    TreeOne<CqasmV3xVariableRef> qq2_variable_ref_sp =
        TreeOne<CqasmV3xVariableRef>{ std::make_shared<CqasmV3xVariableRef>(qq2_variable_ref) };
    TreeOne<CqasmV3xVariableRef> rr2_variable_ref_sp =
        TreeOne<CqasmV3xVariableRef>{ std::make_shared<CqasmV3xVariableRef>(rr2_variable_ref) };
    TreeOne<CqasmV3xIndexRef> rr2_1_index_ref_sp =
        TreeOne<CqasmV3xIndexRef>{ std::make_shared<CqasmV3xIndexRef>(rr2_1_index_ref) };
    TreeOne<CqasmV3xIndexRef> qq6_0_1_2_index_ref_sp =
        TreeOne<CqasmV3xIndexRef>{ std::make_shared<CqasmV3xIndexRef>(qq6_0_1_2_index_ref) };
    TreeOne<CqasmV3xIndexRef> qq6_3_4_5_index_ref_sp =
        TreeOne<CqasmV3xIndexRef>{ std::make_shared<CqasmV3xIndexRef>(qq6_3_4_5_index_ref) };
    ...
    CqasmV3xOperands ops_qq6_0_1_2__qq6_3_4_5 =
        CqasmV3xAny<CqasmV3xValueBase>{ qq6_0_1_2_index_ref_sp, qq6_3_4_5_index_ref_sp };
    ...
    CqasmV3xSgmqGroupsIndices sgmqs_qq6_0_1_2__qq6_3_4_5 =
        std::vector<CqasmV3xOperandIndices>{ op_qq6_0_1_2_indices, op_qq6_3_4_5_indices };
    ...
    CqasmV3xInstructionsIndices cqv3x_ii_qq2__rr2_indices =
        std::vector<CqasmV3xOperandIndices>{ cqv3x_i_qq2_0__rr2_0_indices, cqv3x_i_qq2_1__rr2_1_indices };
    CqasmV3xInstructionsIndices cqv3x_ii_q__rr2_1_indices =
        std::vector<CqasmV3xOperandIndices>{ cqv3x_i_q__rr2_1_indices };
    CqasmV3xInstructionsIndices cqv3x_ii_qq6_0_1_2__qq6_3_4_5_indices = std::vector<CqasmV3xOperandIndices>{
        cqv3x_i_qq6_0__qq6_3_indices, cqv3x_i_qq6_1__qq6_4_indices, cqv3x_i_qq6_2__qq6_5_indices
    };
    ...
    InstructionsIndices ii_qq2_0__rr2_0___qq2_1__rr2_1_indices =
        InstructionsIndices{ i_qq2_0__rr2_0_indices, i_qq2_1__rr2_1_indices };
    InstructionsIndices ii_q__rr2_1_indices = InstructionsIndices{ i_q__rr2_1_indices };
    InstructionsIndices ii_qq6_0_3__qq6_1_4__qq6_2_5_indices =
        InstructionsIndices{ i_qq6_0__qq6_3_indices, i_qq6_1__qq6_4_indices, i_qq6_2__qq6_5_indices };
